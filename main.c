...
/*   Updated: 2021/03/20 22:19:00 by mfrasson         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main(void)
{
	...
	ft_printf("\n   pntr |%020.25p|   string |%-15s|   char |%20.4c|   prcnt |%-5%|   digit |%015.5d|\n\n", &*str, str, 'w', 465782);
	
	ch = printf("   pntr |%020.25p|   string |%-15s|   char |%20.4c|   prcnt |%-5%|   digit |%015.5d|\n\n", &*str, str, 'w', 465782);
