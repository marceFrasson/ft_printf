...
/*   Updated: 2021/03/20 22:42:05 by mfrasson         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main(void)
{
	...
	ft_printf("\n   pntr |%20.5p|   string |%025s|   char |%-4.10c|   prcnt |%5.2%|   digit |%-15.20d|\n\n", &*str, str, 'w', 465782);
	
	ch = printf("   pntr |%20.5p|   string |%025s|   char |%-4.10c|   prcnt |%5.2%|   digit |%-15.20d|\n\n", &*str, str, 'w', 465782);
