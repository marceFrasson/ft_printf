...
/*   Updated: 2021/03/22 03:53:23 by mfrasson         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void		print_flag_p_a(va_list args, t_flags *flag, t_counter *count)
{
	if (flag->dash == 0)
	{
		if (flag->zero == 1)
...
void		print_flag_p(t_flags *flag, t_counter *count)
{
	char *str;
